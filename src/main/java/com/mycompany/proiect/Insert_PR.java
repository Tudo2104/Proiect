 ...
 * @author Tudo
 */
public class Insert_PR extends javax.swing.JFrame {
...
private void Table_Update(){
    ...
    try{
        ...
        PreparedStatement insert = con.prepareStatement("Select * from Furnizori");
    ...
    private void initComponents() {
        ...
        jLabel42.setText("Provider Name:");

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("Provider Address:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
            ...
            var Address = jTextField3.getText();
        
            try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/proiect","root","admin");
            PreparedStatement stmt = con.prepareStatement("INSERT INTO Furnizori (idf, numef, adresa) values (?,?,?)");
            stmt.setString(1,ID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insert_PR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

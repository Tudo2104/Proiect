...
public class SignUpFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        username2.setFont(new java.awt.Font("Segoe UI Semibold", 0, 14)); // NOI18N
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 50, 360, 350));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        var pass = username1.getText();
        var role = username2.getText();

        if (user.equals("") || role.equals("") || pass.equals("")) {
                JOptionPane.showMessageDialog(null, "Verify if you didn't forget to fill a text box!!!!");
        } else {
            try {
                Class.forName("com.mysql.jdbc.Driver");
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/proiect", "root", "admin");
                PreparedStatement stmt = con.prepareStatement("INSERT INTO Login (email, password,role) VALUES (?,?,?)");
